...
For our purposes here, we only need a very elementary understanding of set theory, as a deeper dive, through fascinating, can be very confusing, difficult, and at times controversial.\footnote{This controversy mostly arises from the infamous \href{https://en.wikipedia.org/wiki/Axiom_of_choice}{axiom of choice}. 
...
An important note here is that a set doesn't contain duplicates of one object, therefore, when taking the union, an object is only included once in the output.
